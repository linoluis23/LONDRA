...
public partial class BienestarSocial_RegistroAfiliacionEGS : System.Web.UI.Page
{
    ...
    protected void llenarDatosFamiliar(int pf_id = 0)
    {
        ...
        sc = "$('#modalEditarFamiliar').modal('show');$('#block_tipo_avc').css('display', 'block');$('#block_nro').css('display', 'block');";
    ...
    private string listarGrillaFamiliares()
    {
        ...
        try
        {
            ...
            {
                sc = "$('#block_gvFamiliares').css('display', 'block');$('#block_tipo_avc').css('display', 'block');$('#block_nro').css('display', 'block');";
            }
            else
            {
                sc = "$.notify({ icon: 'fa fa-check', message: 'El funcionario no tiene familiares registrados.'},{type: 'info', placement: { from: 'bottom', align: 'right'} });$('#block_gvFamiliares').css('display', 'none');$('#block_tipo_avc').css('display', 'none');$('#block_nro').css('display', 'none');";
            }
        }
        catch (Exception e)
        {
    ...
    protected void btn_guardar_afiliacion_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < gv_familiares.Rows.Count; i++)
        {
            ...
            if (isChecked)
            {
                ...
                {
                    sc = "$.notify({ icon: 'fa fa-check', message: 'No se puede realizar la acción, se realizó un registro anteriormente.'},{type: 'info', placement: { from: 'bottom', align: 'right'} });$('#block_gvFamiliares').css('display', 'none');$('#block_tipo_avc').css('display', 'none');$('#block_nro').css('display', 'none');";
                }
                else
                {
                    ...
                    {
                        sc = "$.notify({ icon: 'fa fa-check', message: 'No se puede realizar la acción, el beneficiario es mayor de edad.'},{type: 'warning', placement: { from: 'bottom', align: 'right'} });$('#block_gvFamiliares').css('display', 'none');$('#block_tipo_avc').css('display', 'none');$('#block_nro').css('display', 'none');";
                    }
                    else
                    {
                        GuardarAfiliacionFamiliares(masiv_pf_id);
                        sc = "Swal.fire({ icon: 'success', title: 'Afiliación exitosa', text: 'Asignación exitosa', timer: 2200, showConfirmButton: false, allowOutsideClick: false, onAfterClose: () => { $('#block_gvFamiliares').css('display', 'none');$('#block_tipo_avc').css('display', 'none');$('#block_nro').css('display', 'none'); }});";
                    }
                }
            }
        }
    ...
    protected void btn_eliminar_afiliacion_familiar_Click(object sender, EventArgs e)
    {
        ...
        gv_familiares.DataSource = null;
        gv_familiares.DataBind();
        sc = "$.notify({ icon: 'fa fa-trash-alt', message: 'Registro eliminado correctamente.'},{ type: 'success', placement: { from: 'bottom', align: 'right'} });  $('#eliminarAfiliacionFamiliar').modal('hide'); $('body').removeClass('modal-open'); $('.modal-backdrop').remove();$('#block_gvFamiliares').css('display', 'none');$('#block_tipo_avc').css('display', 'none');$('#block_nro').css('display', 'none');";
        SetScript(sc);
    }
    ...
    protected void ddl_estado_vivo_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            case "V":
                sc = "$('#block_fechaDefuncion').css('display', 'none');$('#block_tipo_avc').css('display', 'block');$('#block_nro').css('display', 'block');";
                txt_fecha_defuncion.Text = string.Empty;
                SetScript(sc);
                break;
            case "D":
                sc = "$('#block_fechaDefuncion').css('display', 'block');$('#block_tipo_avc').css('display', 'block');$('#block_nro').css('display', 'block');";
                SetScript(sc);
                break;
            default:
                break;
    ...
    {
        sc = " $('#modalEditarFamiliar').modal('hide'); $('body').removeClass('modal-open'); $('.modal-backdrop').remove();$('#block_tipo_avc').css('display', 'block');$('#block_nro').css('display', 'block');";
        aux_pf_id.Value = "";
        SetScript(sc);
    }
    ...
    {
        sc = "$('#block_gvFamiliares').css('display', 'none');$('#block_tipo_avc').css('display', 'none');$('#block_nro').css('display', 'none');";
        SetScript(sc);
    }
    ...
    {
        if (((txt_ci.Text.Trim() != null && txt_paterno_add.Text.Trim() != null && txt_paterno_add.Text.Trim() != "" && txt_nombre_add.Text.Trim() != null && txt_nombre_add.Text.Trim() != "") || (txt_materno_add.Text.Trim() != null && txt_materno_add.Text.Trim() != "" && txt_nombre_add.Text.Trim() != null && txt_nombre_add.Text.Trim() != "")))
        {
