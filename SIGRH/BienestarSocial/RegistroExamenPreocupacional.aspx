<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="RegistroExamenPreocupacional.aspx.cs" Inherits="BienestarSocial_RegistroExamenPreocupacional" %>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive py-4">
                        <asp:UpdatePanel ID="up_gv_items" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gv_items" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" OnPreRender="gv_items_PreRender" OnRowCommand="gv_items_RowCommand" DataKeyNames="as_per_id, as_id, exp_id" runat="server">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="afp_previsora" HeaderText="Afp" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
                                        <asp:BoundField DataField="afp_nua" HeaderText="Nua" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
                                        <asp:BoundField DataField="exp_fecha_prog" HeaderText="Fecha examen" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
                                        <asp:BoundField DataField="exp_fecha_elab" HeaderText="Fecha dec. examen" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
...
<%--                                        <asp:TemplateField HeaderText="Opciones" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" HeaderStyle-Width="130px">
                                            <ItemTemplate>
                                                <asp:LinkButton CommandName="GetAssign" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn btn-vimeo text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-calendar-check fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='Programar nuevo examen' Visible='<%# Eval("afp_nua").ToString() != "" ? true : false %>' runat="server" />
                                                <asp:LinkButton CommandName="GetAssignConfirm" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn btn-slack text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-check fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='Declarar Examen' Visible='<%# Eval("exp_fecha_prog").ToString() != "" ? true : false %>' runat="server" />
                                                <asp:LinkButton CommandName="GetAssignAnalisis" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn btn-secondary text-black-50 btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-plus-square fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='Análisis Examen' Visible='<%# Eval("exp_fecha_elab").ToString() != "" ? true : false %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                        <asp:TemplateField HeaderText="Opciones" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" HeaderStyle-Width="130px">
                                            <ItemTemplate>
                      ...
                      <%--                                  <a class="dropdown-item" href="#">Action</a>
                                                        ...
                                                        <a id="btnSalir" class="dropdown-item" href="#"><i class="fas fa-calendar-check"></i><span>Programar nuevo examen</span></a>--%>
                                                        <asp:LinkButton CommandName="GetAssign" CommandArgument="<%# Container.DataItemIndex %>" CssClass="dropdown-item" Text="<i class='fas fa-calendar-check'></i><span>Programar nuevo examen</span>" runat="server" />
                                                        <asp:LinkButton CommandName="GetAssignConfirm" CommandArgument="<%# Container.DataItemIndex %>" CssClass="dropdown-item" Text="<i class='fas fa-cloud-upload-alt'></i><span>Declarar Examen</span>" runat="server" />
                                                        <asp:LinkButton CommandName="GetAssignAnalisis" CommandArgument="<%# Container.DataItemIndex %>" CssClass="dropdown-item" Text="<i class='fas fa-vial'></i><span>Análisis Examen</span>" runat="server" />
                                                    </div>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
