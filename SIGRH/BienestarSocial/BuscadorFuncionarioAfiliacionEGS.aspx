<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="BuscadorFuncionarioAfiliacionEGS.aspx.cs" Inherits="BienestarSocial_BuscadorFuncionarioAfiliacionEGS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container-fluid mt--6">
            ...
            <div class="card-header">
                <div class=" ct-page-title">
                    ...
                    <p class="text-sm mb-0">
                        Para su búsqueda,  puede usar los filtros y/o las siguientes opciones mostrados en la parte inferior.
                    </p>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <ContentTemplate>
                        <asp:Panel CssClass="card-body" DefaultButton="BtnBuscar" runat="server">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        <label class="form-control-label text-org2" for="exampleFormControlSelect1">Caja Aseguradora</label>
                                        <asp:DropDownList ID="ddl_tipo_egs" AppendDataBoundItems="true" CssClass="form-control select2" data-minimum-results-for-search="Infinity" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        <label class="form-control-label text-org2" for="exampleFormControlSelect1">Estado Afiliación</label>
                                        <asp:DropDownList ID="ddl_estado_afiliacion" AppendDataBoundItems="true" CssClass="form-control select2" data-minimum-results-for-search="Infinity" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-2">
                                    <div class="form-group">
                                        <label class="form-control-label" for="example4cols7Input">&nbsp</label>
                                        <asp:LinkButton ID="BtnBuscar" CssClass="btn btn-info btn-block" Text="<i class='fas fa-search'></i> Buscar / Filtrar" OnClick="BtnBuscar_Click" runat="server" />
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-1">
                                    <div class="form-group text-right">
                                        <asp:UpdatePanel ID="up_limpliar" runat="server">
                                            <ContentTemplate>
                                                <label class="form-control-label" for="example4cols7Input">&nbsp</label>
                                                <asp:LinkButton ID="btnLimpiar" CssClass="btn btn-warning btn-block" Text="Limpiar" OnClick="btnLimpiar_Click" runat="server" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive py-4">
                        <asp:UpdatePanel ID="up_gv_items" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gv_items" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" OnPreRender="gv_items_PreRender" OnRowCommand="gv_items_RowCommand" DataKeyNames="as_per_id, per_num_doc, as_id, fa_id" runat="server">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="egs_descripcion" HeaderText="E.G.S." HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
                                        <asp:BoundField DataField="ae_estado" HeaderText="Estado Afiliación" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
                                        <asp:TemplateField HeaderText="Opciones" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" HeaderStyle-Width="130px">
                                            <ItemTemplate>
                                                <asp:LinkButton CommandName="GetAssign" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn bg-gradient-inst text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-plus fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='Afiliar' Visible='<%# Eval("ae_estado").ToString() == "P" ? true : false %>' runat="server" />
                                                <asp:LinkButton CommandName="GetEdit" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn btn-warning btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-edit fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='Editar Afiliación' Visible='<%# Eval("ae_estado").ToString() == "A" ? true : false %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                                ...
                                <div class="modal-body p-0">
                                    <div class="card bg-secondary border-0 mb-0">
                                        ...
                                        <div class="form-group text-center">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                    <asp:LinkButton ID="btn_asignar_afiliacionEGS" Text="<i class='fas fa-check mr-2'></i>Guardar" ValidationGroup="addGuardar" CssClass="btn btn-success" OnClick="btn_asignar_afiliacionEGS_Click" runat="server" />
                                                    <asp:LinkButton ID="btn_cancelar_afiliacion" class="btn btn-outline-github" Text="<i class='fas fa-times mr-2'></i>Cancelar" OnClick="btn_cancelar_afiliacion_Click" runat="server" />
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card bg-secondary border-0 mb-0">
                                                ...
                                                <div class="card-body px-lg-5 py-lg-5">
                                                    ...
                                                    <div class="row pt-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <asp:LinkButton ID="btn_cancelar_glosa" class="btn btn-outline-github btn-block" Text="<i class='fas fa-times mr-2'></i>Cancelar" OnClick="btn_cancelar_glosa_Click1" runat="server" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <asp:UpdateProgress ID="up2" AssociatedUpdatePanelID="up_gv_items" runat="server">
            <ProgressTemplate>
                <div class="load"></div>
            </ProgressTemplate>
        </asp:UpdateProgress>
