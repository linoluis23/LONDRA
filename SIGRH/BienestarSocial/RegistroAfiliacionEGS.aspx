                            ...
                            <asp:UpdatePanel ID="panelGuardarAfiliacion" runat="server">
                                <ContentTemplate>
                                    <div class="row">
                                        ...
                                        <div id="block_nro" class="col-md-6" style="display: none">
                                            <div class="form-group">
                                                <label class="form-control-label">Nro de Matricula del Familiar</label>
                                                <div class="input-group input-group-merge">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><i class="fas fa-user-tag"></i></span>
                                                    </div>
                                                    <asp:TextBox ID="txt_matri_familiar" CssClass="form-control letras" runat="server" />
                                                </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge">
                                                                    ...
                                                                    <asp:TextBox ID="txt_ci" class="form-control" runat="server" />
                                                                </div>
                                                                <asp:RequiredFieldValidator CssClass="text-danger display-5" ErrorMessage="(*) Campo Obligatorio" Display="Dynamic" ControlToValidate="txt_ci" ValidationGroup="familiarAdd" runat="server" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
