...
public partial class MovimientoPersonal_CuentaBancaria : System.Web.UI.Page
{
    ...
    protected void gv_items_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            case "GetAssign":
                ...
                Response.Redirect("RegistroCuentaBancaria?id=" + per_id + "&id2=" + as_id);
                break;
    ...
    private void BindGridView(string varId, string varCed, string varPat, string varMat, string varNom, string varCas)
    {
        ...
        try
        {
            ...
            gv_items.DataSource = _persona.ObtenerTablaGrilla__gamlp_vigente(varId, "", varCed, "", varPat, varMat, varNom, varCas, "", "", "", "", "", "", pr_id);
            gv_items.DataBind();
        }
