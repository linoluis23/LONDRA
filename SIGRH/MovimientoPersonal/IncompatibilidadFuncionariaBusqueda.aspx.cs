...
public partial class MovimientoPersonal_IncompatibilidadFuncionariaBusqueda : System.Web.UI.Page
{
    ...
    protected void Gv_busqueda_lista_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("Btn_nuevo_registro")) { Response.Redirect("IncompatibilidadFuncionaria?id=" + code); }
        SetScript(sc);
    }
