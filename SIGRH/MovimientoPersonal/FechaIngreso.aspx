<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="FechaIngreso.aspx.cs" Inherits="MovimientoPersonal_FechaIngreso" %>
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Fecha de Ingreso</h6>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid mt--6">
            ...
            <div class="card">
                ...
                <div class="table-responsive py-4">
                    <asp:UpdatePanel ID="up_gv_items" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="gv_items" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" OnPreRender="gv_items_PreRender" OnRowDataBound="gv_items_RowDataBound" OnRowCommand="gv_items_RowCommand" DataKeyNames="as_per_id, as_estado" runat="server">
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-CssClass="text-center" HeaderStyle-Width="100px">
                                        <HeaderTemplate>
                                            <span class="badge badge-lg badge-darkerw">fECHA INGRESO</span>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" placeholder="Ej.: d/m/a" CssClass="form-group" ID="txtFechaIngreso"  Text='<%# Eval("pasig_fecha_asig")%>'  Width="75px" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Opciones" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" HeaderStyle-Width="130px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnbInsertar" Visible="true" CommandName="Insertar" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn bg-gradient-inst text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-check fa-lg'>Adicionar</i></span>" data-toggle='tooltip' data-placement='top' title='Insertar' runat="server" />
                                            <%--                                            <asp:LinkButton CommandName="FileVirtual" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn bg-gradient-inst text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-file fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='FileVirtual' runat="server" />--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
    ...
    <div id="divFechas" class="row" style="display: none">
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <div class=" ct-page-title">
                        <h3 class="mb-0">Fechas de Ingreso</h3>
                        <p class="text-sm mb-0">
                ...
                <div class="table-responsive py-4">
                    <asp:UpdatePanel ID="PanelFechas" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="gvFechas" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" OnPreRender="gvFechas_PreRender"  DataKeyNames="" runat="server">
                                <Columns>
                                    <asp:BoundField DataField="as_per_id" HeaderText="Código" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
                                    <asp:BoundField DataField="per_ap_paterno" HeaderText="Apellido Paterno" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
                                    <asp:BoundField DataField="per_ap_materno" HeaderText="Apellido Materno" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
                                    ...
                                    <asp:TemplateField HeaderText="Opciones" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" HeaderStyle-Width="130px">
                                        <ItemTemplate>
                                            <asp:LinkButton CommandName="Insertar" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn bg-gradient-inst text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-plus fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='Insertar' runat="server" />
                                            <%--                                            <asp:LinkButton CommandName="FileVirtual" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn bg-gradient-inst text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-file fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='FileVirtual' runat="server" />--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
    ...
    <asp:UpdateProgress ID="UpdateProgress1" AssociatedUpdatePanelID="PanelFechas" runat="server">
        <ProgressTemplate>
            <div class="load"></div>
        </ProgressTemplate>
    </asp:UpdateProgress>
