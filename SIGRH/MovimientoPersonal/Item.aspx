<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="Item.aspx.cs" Inherits="MovimientoPersonal_Item" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Creación de item(s) de Contrato o Consultoría</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-lg-7" data-select2-id="9">
                <div class="card mb-4 ">
                    <!-- Card header -->
                    <div class="card-header">
                        <div class=" ct-page-title">
                            ...
                            <p class="text-sm mb-0">
                                Seleccione la Unidad Organizacional requerida.
                            </p>
                        </div>
                    </div>
            ...
            <div class="col-lg-5" runat="server" id="divCategoria">
                        ...
                        <div class="card-header d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center ct-page-title">
                                <div class="text-dark font-weight-600 text-sm">
                                    <h3 class="mb-0">Creación de items de Contrato o Consultoría</h3>
                                    <p class="text-sm mb-0">Detalle del item a crear o seleccionado.</p>
                                </div>
                            </div>
                            <div class="text-right ml-auto" id="botonSuplencia" style="display: none">
                                        <asp:LinkButton ID="btnSuplencia" CssClass="btn btn-default btn-round btn-icon" data-toggle="tooltip" data-original-title="Imprimir" Text="<span class='btn-inner--icon'><i class='fas fa-users-cog'></i></span><span class='btn-inner--text'>Suplencia</span>" OnClick="btnSuplencia_Click" runat="server" />
                            </div>
                        </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="content-text-label">Categoria programática</div>
                                            <div class="h5 font-weight-400 content-text">
                                                <asp:Literal ID="lvl_unidad_org" runat="server" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="content-text-label">Categoria administrativa</div>
                                            <div class="h5 font-weight-400 content-text text-uppercase">
                                                <asp:Literal ID="ltl_categoria" runat="server" />
                                            </div>
                                        </div>
                                    </div>
                                    <div id="detalleitem" style="display: none">
                                        <asp:HiddenField ID="p_ca_haber_basico" runat="server" />
                                        <asp:HiddenField ID="p_ca_haber_basico_suplencia" runat="server" />
                                        <asp:HiddenField ID="p_eo_id" runat="server" />

                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="content-text-label">Código escalafón</div>
                                                <div class="h5 font-weight-400 content-text">
                                                    <asp:Literal ID="ltl_codigo" runat="server" />
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddl_tipo_item" AppendDataBoundItems="true" CssClass="form-control select2" data-minimum-results-for-search="Infinity" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddl_tipo_item_SelectedIndexChanged"></asp:DropDownList>
                                        <asp:RequiredFieldValidator CssClass="text-danger display-5" ErrorMessage="(*) Campo Obligatorio" ControlToValidate="ddl_tipo_item" Display="Dynamic" ValidationGroup="addItem" runat="server" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator CssClass="text-danger display-5" ErrorMessage="(*) Campo Obligatorio" ControlToValidate="ddl_cargo" Display="Dynamic" ValidationGroup="addItem" InitialValue="0" runat="server" />
                                    </div>
                                   </ContentTemplate>
                                    </asp:UpdatePanel>
...
<%--                                                    <asp:ListItem Text="TIEMPO COMPLETO" Value="TC" />
                                            ...
                                            <asp:RequiredFieldValidator CssClass="text-danger display-5" ErrorMessage="(*) Campo Obligatorio" Display="Dynamic" ControlToValidate="ddl_tipo_jornada" ValidationGroup="addItem" runat="server" />
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label class="form-control-label" for="exampleFormControlInput1">Cantidad</label>
                                                <div class="input-group input-group-merge">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><i class="fas fa-hashtag"></i></span>
                                                    </div>
                                                    <asp:TextBox CssClass="form-control numero" AutoComplete="off" ID="txt_cantidad" runat="server" />
                                                </div>
                                                <asp:RequiredFieldValidator CssClass="text-danger display-5" ErrorMessage="(*) Campo Obligatorio" Display="Dynamic" ControlToValidate="txt_cantidad" ValidationGroup="addItem" runat="server" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-5" id="botonGuardar" style="display: none">
                                            <div class="form-group text-right">
                                                <asp:UpdatePanel runat="server">
                                                    <ContentTemplate>
                                                        <asp:LinkButton ID="btnFiltrar" OnClick="btnFiltrar_Click" CssClass="btn btn-vimeo btn-block btn-icon mb-3 mb-sm-0" ValidationGroup="addItem" Text="<span class='btn-inner--icon'><i class='fas fa-save'></i></span><span class='btn-inner--text'>Crear</span>" runat="server" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
            ...
            <div class="col-lg-5" visible="false" runat="server" id="divAlerta">
                <div class="card-wrapper" >
                    <div class="card-header">
                        <div class=" ct-page-title">
                            <h3 class="mb-0">Creación de Items</h3>
                            <h1 class="text-sm mb-0 text-red">
                                La creación de items de Planta está restringida
                            </h1>
                        </div>
                <hr />
                <div class="row"></div>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="ddl_tipo_documento" EventName="SelectedIndexChanged" />
            <asp:AsyncPostBackTrigger ControlID="btn_adicionar_glosa" EventName="Click" />
        </Triggers>
    </asp:UpdatePanel>
    <asp:UpdateProgress AssociatedUpdatePanelID="UpdatePanelItem" runat="server">
        <ProgressTemplate>
            <div class="load"></div>
        </ProgressTemplate>
    </asp:UpdateProgress>
