...
public partial class MovimientoPersonal_ModificacionValidacion : System.Web.UI.Page
{
    ...
    private void informacionFuncionarioAlta(string ci = "", string gestion = "")
    {
        ...
        if (detalleFuncionario.Tables.Count > 0)
        {
            if (detalleFuncionario.Tables[0].Rows.Count > 0)
            {
                ...
                sc = "$.notify({ icon: 'fa fa-check', message: 'Datos seleccionados correctamente'},{type: 'success', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'block'); $('#block_modificar').css('display', 'block'); $('#block_gv_validar').css('display', 'block');$('#block_reprobar').css('display', 'block');";
            }
            else
            {
                Limpiar();
                sc = "$.notify({ icon: 'fa fa-info', message: 'No se encontraron resultados'},{type: 'warning', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'none'); $('#block_modificar').css('display', 'none');$('#block_reprobar').css('display', 'none');";
            }
            SetScript(sc);
        }
    }
    ...
    private void informacionFuncionarioBaja(string ci = "", string gestion = "")
    {
        ...
        if (detalleFuncionario.Tables.Count > 0)
        {
            ...
            {
                armarEstructura(detalleFuncionario);
                sc = "$.notify({ icon: 'fa fa-check', message: 'Datos seleccionados correctamente'},{type: 'success', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'block'); $('#block_modificar').css('display', 'block');$('#block_reprobar').css('display', 'block');";
            }
            else
            {
                Limpiar();
    ...
    private void informacionFuncionarioAltasCI(string ci = "", string gestion = "")
    {
        ...
        if (detalleFuncionario.Tables.Count > 0)
        {
            ...
            {
                armarEstructura(detalleFuncionario);
                sc = "$.notify({ icon: 'fa fa-check', message: 'Datos seleccionados correctamente'},{type: 'success', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'block'); $('#block_modificar').css('display', 'block'); $('#block_datos_fun_int').css('display', 'block'); $('#block_datos_adicionales_int').css('display', 'block');$('#block_reprobar').css('display', 'block');";
            }
            else
            {
                Limpiar();
                sc = "$.notify({ icon: 'fa fa-info', message: 'No se encontraron resultados'},{type: 'warning', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'none'); $('#block_modificar').css('display', 'none'); $('#block_datos_fun_int').css('display', 'none'); $('#block_datos_adicionales_int').css('display', 'none');$('#block_reprobar').css('display', 'none');";
            }
            SetScript(sc);
        }
    }
    ...
    private void informacionFuncionarioMemosVarios(string ci = "", string gestion = "")
    {
        ...
        if (detalleFuncionario.Tables.Count > 0)
        {
            ...
            {
                armarEstructura(detalleFuncionario);
                sc = "$.notify({ icon: 'fa fa-check', message: 'Datos seleccionados correctamente'},{type: 'success', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'block'); $('#block_modificar').css('display', 'block'); $('#block_datos_memo').css('display', 'block');$('#block_reprobar').css('display', 'block');";
            }
            else
            {
                Limpiar();
                sc = "$.notify({ icon: 'fa fa-info', message: 'No se encontraron resultados'},{type: 'warning', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'none'); $('#block_modificar').css('display', 'none'); $('#block_datos_memo').css('display', 'none');$('#block_reprobar').css('display', 'none');";
            }
            SetScript(sc);
        }
    }
    ...
    protected void btn_reprobar_validacion_Click(object sender, EventArgs e)
    {
        ...
        {
            case "1":
                seg_memo.EliminarRegistroValidacion();
                Limpiar();
                sc = "$.notify({ icon: 'fa fa-trash-alt', message: ' Registro eliminado correctamente'},{ type: 'success', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'none'); $('#block_modificar').css('display', 'none'); $('#block_gv_validar').css('display', 'none');$('#block_reprobar').css('display', 'none');";
                break;
            case "2":
                seg_memo.EliminarRegistroValidacion();
                Limpiar();
            ...
            case "3":
                ...
                break;
            case "4":
                seg_memo.EliminarRegistroValidacionCI();
                Limpiar();
                sc = "$.notify({ icon: 'fa fa-check', message: ' Registro eliminado correctamente'},{type: 'success', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'none'); $('#block_modificar').css('display', 'none'); $('#block_gv_validar').css('display', 'none');$('#block_reprobar').css('display', 'none');";
                break;
            case "5":
                seg_memo.EliminarRegistroValidacionCI();
                Limpiar();
                ...
                break;
            case "7":
                seg_memo.EliminarRegistroValidacionMemosVarios();
                Limpiar();
                sc = "$.notify({ icon: 'fa fa-check', message: ' Registro eliminado correctamente'},{type: 'success', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'none'); $('#block_modificar').css('display', 'none'); $('#block_gv_validar').css('display', 'none');$('#block_reprobar').css('display', 'none');";
                break;
            default:
    ...
    protected void btn_guardar_validacion_Click(object sender, EventArgs e)
    {
        ...
        switch (ddl_validaMemo.SelectedValue)
        {
            case "1":
                ...
                Limpiar();
                sc = "$.notify({ icon: 'fa fa-check', message: 'Datos validados correctamente'},{type: 'success', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'none'); $('#block_aprobar').css('display', 'none'); $('#block_gv_validar').css('display', 'none');";
                break;
            case "2":
                seg_memo.ActualizarValidacionAlta();
                Limpiar();
    ...
    protected void btn_modificar_validacion_Click(object sender, EventArgs e)
    {
        seg_memo = new cls_mp_seguimiento_memorandum();
        seg_memo.as_id = Convert.ToInt32(aux_as_id.Value);
        seg_memo.mh_per_id = Convert.ToInt32(aux_as_per_id.Value);
        ...
        switch (ddl_validaMemo.SelectedValue)
        {
            case "1":
                ...
                Limpiar();
                sc = "$.notify({ icon: 'fa fa-check', message: 'Datos modificados correctamente'},{type: 'success', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'none'); $('#block_modificar').css('display', 'none'); $('#block_gv_validar').css('display', 'none');$('#block_reprobar').css('display', 'none');";
                break;
            case "2":
                seg_memo.ModificarValidacionAlta();
                Limpiar();
            ...
            case "3":
                ...
                break;
            case "4":
                seg_memo.ModificarValidacionAltaCI();
                Limpiar();
                sc = "$.notify({ icon: 'fa fa-check', message: 'Datos modificados correctamente'},{type: 'success', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'none'); $('#block_modificar').css('display', 'none'); $('#block_gv_validar').css('display', 'none');$('#block_reprobar').css('display', 'none');";
                break;
            case "5":
                ...
                break;
            case "7":
                seg_memo.ModificarValidacionMemosVarios();
                Limpiar();
                sc = "$.notify({ icon: 'fa fa-check', message: 'Datos modificados correctamente'},{type: 'success', placement: { from: 'bottom', align: 'right'} }); $('#block_datos_funcionario').css('display', 'none'); $('#block_modificar').css('display', 'none'); $('#block_gv_validar').css('display', 'none');$('#block_reprobar').css('display', 'none');";
                break;
            default:
