<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="ModificacionValidacion.aspx.cs" Inherits="MovimientoPersonal_ModificacionValidacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Edición de Validaciones</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt--6">
                ...
                <div class="card-wrapper">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div id="block_modificar" class="col-sm-6 col-md-6" style="display: none">
                                    <div class="form-group">
                                        <label class="form-control-label" for="example4cols3Input">&nbsp</label>
                                        <asp:UpdatePanel ID="up_modificar" runat="server">
                                            <ContentTemplate>
                                                <asp:LinkButton ID="btn_modificar_validacion" CssClass="btn btn-warning btn-block" Text="<i class='fas fa-edit'></i> Modificar" OnClick="btn_modificar_validacion_Click" runat="server" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                </div>
                                <div id="block_reprobar" class="col-sm-6 col-md-6" style="display: none">
                                    <div class="form-group">
                                        ...
                                        <asp:UpdatePanel ID="up_reprobar" runat="server">
                                            <ContentTemplate>
                                                <asp:LinkButton ID="btn_reprobar_validacion" CssClass="btn btn-danger btn-block" Text="<i class='fas fa-trash'></i> Reprobar" OnClick="btn_reprobar_validacion_Click" runat="server" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                </div>
        ...
        <div class="row">
            ...
            <div id="block_gv_validar" class="col-lg-8 accordion" style="display: none">
                <div class="card">
                    <div class="card-header border-bottom" id="colValidar" data-toggle="collapse" data-target="#collapseGrilla" aria-expanded="false" aria-controls="collapseGrilla">
                        <div class=" ct-page-title">
                            <h3 class="mb-0">Listado de Ítem(s) para Validar </h3>
                            <p class="text-sm mb-0">
                                Listado de asignaciones.
                            </p>
                        </div>
                    </div>
                    <div id="collapseGrilla" class="collapse" aria-labelledby="colValidar" data-parent="#block_gv_validar">
                        <asp:UpdatePanel ID="up_GvItems" runat="server">
                            <ContentTemplate>
                                <div class="card-body">
                                    <asp:GridView ID="gv_validar_items" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" OnPreRender="gv_validar_items_PreRender" DataKeyNames="as_id" runat="server">
                                        <Columns>
                                            <asp:BoundField DataField="per_id" HeaderText="Código Funcionario" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
        ...
        <asp:UpdateProgress ID="up_3" AssociatedUpdatePanelID="up_modificar" runat="server">
            <ProgressTemplate>
                <div class="load"></div>
            </ProgressTemplate>
        </asp:UpdateProgress>
        <asp:UpdateProgress ID="up_4" AssociatedUpdatePanelID="up_reprobar" runat="server">
            <ProgressTemplate>
                <div class="load"></div>
            </ProgressTemplate>
        </asp:UpdateProgress>
         <asp:UpdateProgress ID="up5" AssociatedUpdatePanelID="up_GvItems" runat="server">
            <ProgressTemplate>
                <div class="load"></div>
            </ProgressTemplate>
        </asp:UpdateProgress>
