<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="ListaPlanillaContrato.aspx.cs" Inherits="MovimientoPersonal_ListaPlanillaContrato" %>
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Planillas para Contratación de Personal</h6>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 card-wrapper ct-example">
                <div class="card">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="text-dark font-weight-600 text-sm">
                                <div class=" ct-page-title">
                                    <h3 class="mb-0">Búsqueda de Planillas</h3>
                    ...
                    <div id="d_planillas" style="display: none">
                                                ...
                                                <div class="row align-items-center px-3">
                                                    <div class="col-10">
                                                        <asp:LinkButton ID="tDatail1" CommandName="GetAssign" CommandArgument="<%# Container.DataItemIndex %>" data-toggle='tooltip' data-placement='top' title='Ver Planilla' runat="server">
                                                            ...
                                                            <div class="row flex-nowrap">
                                                                <div class="list-view-item-title">Fecha Validación por RRHH: </div>
