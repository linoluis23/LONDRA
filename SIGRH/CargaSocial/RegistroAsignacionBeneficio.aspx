        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="card-wrapper">
                            ...
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <div class="row">
                                        ...
                                        <div id="block_asig_mismo" class="col-md-3" style="display: block">
                                            <div class="form-group">
                                                <label class="form-control-label" for="example3cols1Input">Asignar al funcionario &nbsp</label>
                                                <asp:LinkButton ID="btn_autoasig" OnClick="btn_autoasig_Click" CssClass="btn btn-facebook btn-block btn-icon" Text="<span class='btn-inner--icon'><i class='fas fa-user-alt'></i></span><span class='btn-inner--text'>Asignar benef</span>" runat="server" />
                                            </div>
                                        </div>
                        ...
                        <div class="table-responsive py-4" id="block_gvFamiliares" style="display: none">
                            <asp:UpdatePanel ID="panelGvFamiliares" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView ID="gv_familiares" CssClass="table table-bordered table-hover table-striped" OnRowDataBound="gv_familiares_RowDataBound" AutoGenerateColumns="false" OnPreRender="gv_familiares_PreRender" OnRowCommand="gv_familiares_RowCommand" DataKeyNames="pf_id" runat="server">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ci" HeaderText="CI" HeaderStyle-CssClass="text-center" />
                                            <asp:TemplateField HeaderText="Opciones" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" HeaderStyle-Width="130px">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="btn_asignar" CommandName="GetAsig" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn bg-gradient-inst text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-plus fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='Asignar Beneficio' runat="server" />
                                                    <asp:LinkButton ID="btn_Afiliar" CommandName="GetAfili" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn bg-gradient-inst text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-briefcase-medical fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='Afiliar beneficiario' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                                ...
                                <ContentTemplate>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label class="form-control-label">Nro de matricula:</label>
                                                    <asp:TextBox ID="txt_matri_benef" CssClass="form-control" runat="server" />
                                                    <%--<asp:RequiredFieldValidator CssClass="text-danger display-5" ErrorMessage="(*) Campo Obligatorio" ControlToValidate="txt_matri_benef" Display="Dynamic" ValidationGroup="addGuardar" runat="server" />--%>
                                                </div>
                                            </div>
                                        </div>
                                        <%--<div class="col-sm-6 col-md-6">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge">
                                                                    ...
                                                                    <asp:TextBox ID="txt_ci_edit" class="form-control" runat="server" />
                                                                </div>
                                                                <asp:RequiredFieldValidator CssClass="text-danger display-5" ErrorMessage="(*) Campo Obligatorio" Display="Dynamic" ControlToValidate="txt_ci_famili" ValidationGroup="familiarAdd" runat="server" />
                                                            </div>
                                                        </div>
                                                        <%--<div class="col-sm-6 col-md-4">
                                                            <div class="form-group">
                    ...
                    <!-- Registrar Afiliacion Beneficiario -->
                    <div class="modal fade" id="RegistrarAfiliacionBeneficiario" tabindex="-1" role="dialog" aria-labelledby="modal-notification" style="display: none;" aria-hidden="true">
                                    ...
                                    <ContentTemplate>
                                        <div class="modal-header">
                                            <div class="text-center mt-2 mb-3">
                                                <h4 class="header-modal">REGISTRO AFILIACION BENEFICIARIO</h4>
                                            </div>
                                        </div>
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label class="form-control-label" for="exampleFormControlSelect1">Matricula Seguro</label>
                                                <div class="input-group input-group-merge">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><i class="fas fa-edit"></i></span>
                                                    </div>
                                                    <asp:TextBox ID="txt_nro_matricula_benefic" class="form-control" runat="server" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group text-center">
                                            <asp:LinkButton ID="btn_afiliar_benef" OnClick="btn_afiliar_benef_Click" Text="<i class='fas fa-check mr-2'></i>Adicionar" CssClass="btn btn-success" runat="server" />
                                            <button type="button" class="btn btn-outline-github" data-dismiss="modal"><i class="fas fa-times mr-2"></i>Cancelar</button>
                                        </div>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge">
                                                                    ...
                                                                    <asp:TextBox ID="txt_ci_famili" class="form-control" runat="server" />
                                                                </div>
                                                                <asp:RequiredFieldValidator CssClass="text-danger display-5" ErrorMessage="(*) Campo Obligatorio" Display="Dynamic" ControlToValidate="txt_ci_famili" ValidationGroup="familiarAdd" runat="server" />
                                                            </div>
                                                        </div>
