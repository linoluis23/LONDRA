<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="PlanillaLiquidosPagables.aspx.cs" Inherits="Administración_PlanillaLiquidosPagables" %>
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Líquidos Pagables</h6>
                    </div>
                </div>
            </div>
        </div>
