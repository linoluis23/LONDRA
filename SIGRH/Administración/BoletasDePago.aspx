<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="BoletasDePago.aspx.cs" Inherits="Administración_BoletasDePago" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Boletas de Pago</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt--6"  >
        ...
        <div class="col-lg-4" runat="server" visible="false" id="DivTipoPersonal">
            <div class="card">
            <div class="card-header border-bottom">
                <div class="ct-page-title">
                    <h3 class="mb-0">Elejir el tipo de personal</h3>
        ...
        <div class="col-lg-4"  runat="server" visible="false" id="DivTipoTrabajo">
        <div class="card">
            <div class="card-header border-bottom">
                <div class="ct-page-title">
                    <h3 class="mb-0">Elegir el tipo de relación Laboral:</h3>
    ...
    <div class="card-body text-right top--5" runat="server" id="divBtn" visible="false">
       <asp:LinkButton ID="btnVerReporte" CssClass="btn btn-success" Text="<i class='fas fa-save'></i> Ver Reporte" ValidationGroup="planilla" o   runat="server" OnClick="btnVerReporte_Click" />
    </div>
