<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="ReporteAltasBajas.aspx.cs" Inherits="Administración_ReporteAltasBajas" %>
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Planilla General de Altas y Bajas</h6>
                    </div>
                </div>
            </div>
        </div>
...
<%--                    <h3 class="mb-0">Planilla de Haberes</h3>--%>
                    <p class="text-sm mb-0">Seleccione el tipo de movimiento:</p>
        ...
        <div class="card">
            <div class="card-header border-bottom">
                <div class="ct-page-title">
                    <h3 class="mb-0">Unidad Org.:</h3>
                    <asp:DropDownList ID="ddlUnidad" CssClass="form-control select2" AppendDataBoundItems="true" runat="server"   />
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="card">
            <div class="card-header border-bottom">
                <div class="ct-page-title">
                    ...
                    <asp:DropDownList ID="ddlItem" CssClass="form-control select2" AppendDataBoundItems="true" runat="server"   />
                </div>
            </div>
        </div>
        </div>
        <div class="col-lg-4">
            <div class="card-body text-right top--4">
