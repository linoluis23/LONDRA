<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="PlanillaHaberesAdicionales.aspx.cs" Inherits="Administración_PlanillaHaberesAdicionales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container-fluid mt--6"  >
        ...
        <%--                    <h3 class="mb-0">Planilla de Haberes</h3>--%>
            ...
            <div class="col-lg-2 card-wrapper" runat="server" id="divAdicional" visible="false">
                <div class="card">
                    <div class="card-header border-bottom">
                        <div class="ct-page-title">
        <%--                    <h3 class="mb-0">Planilla de Haberes</h3>--%>
                            <h3 class="mb-0">Planilla:</h3>

                            <asp:DropDownList ID="ddlAdicional" CssClass="form-control select2" AppendDataBoundItems="true" runat="server"   OnSelectedIndexChanged="ddlAdicional_SelectedIndexChanged" />
        ...
        <div class="col-lg-3 card-wrapper" runat="server"  id="DivTipoPersonal" visible="false">
        <div class="card">
            <div class="card-header border-bottom">
                <div class="ct-page-title">
...
<%--                    <p class="text-sm mb-0">Seleccione el mes:</p>--%>
            ...
            <div id="divAporte" class="col-lg-3 card-wrapper" visible="false" runat="server">
                <div class="row">
            ...
            <div class="col-lg-2 card-wrapper" runat="server" visible="false" id="divExcel">
                <asp:CheckBox Text="Formato en Excel" CssClass="form-check" Font-Bold="true" Font-Size="Large"  ID="chkExcel"  OnCheckedChanged="chkExcel_CheckedChanged" AutoPostBack="true" runat="server" />
            </div>
        </div>
    </div>
