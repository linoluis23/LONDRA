...
public partial class Administración_ReporteFPC_FondoSolidario_PREVISION : System.Web.UI.Page
{
    ...
    private void CargarReporte()
    {
        ...
        if (HttpContext.Current.Session["VerGenerar"] != null && HttpContext.Current.Session["VerGenerar"].ToString() != "")
        {
            ...
            ReportViewer1.ServerReport.ReportPath = "/ReportesUAP/REPORTE_FPC_FS_PREVISION";
        }
