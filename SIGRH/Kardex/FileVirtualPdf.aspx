<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="FileVirtualPdf.aspx.cs" Inherits="Kardex_FileVirtualPdf" %>
...
<%--    <asp:UpdatePanel runat="server" ID="panel2">
    ...
    <div class="container-fluid mt--4 ml-6">
        <div class="row">
            <div class="col-11 card">
           <div class="form-group col-md-11 ml-3 text-center">
           </div>

            </div>
         </div>
    </div>
    <div class="container-fluid mt--4 ml-9">
        <div class="row">
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="ddlDocs" EventName="SelectedIndexChanged" />
        </Triggers>
    </asp:UpdatePanel> --%>
