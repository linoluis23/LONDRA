...
public partial class Kardex_BuscadorFuncionarioPlantaVac : System.Web.UI.Page
{
    ...
    protected void gv_items_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            case "GetAssign":
                ...
                Response.Redirect("RegistroVacaciones?id=" + per_id);
                break;
    ...
    private void BindGridView(string varId, string varCed, string varPat, string varMat, string varNom, string varCas)
    {
        try
        {
            ...
            gv_items.DataSource = _persona.ObtenerTablaGrilla__persona_plantaVacaciones(varId, "", varCed, "", varPat, varMat, varNom, varCas, "", "", "", "", "", "");
            gv_items.DataBind();
        }
