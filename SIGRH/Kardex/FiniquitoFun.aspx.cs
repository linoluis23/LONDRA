...
public partial class Kardex_FiniquitoFun : System.Web.UI.Page
{
    ...
    protected void gv_items_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case "GetAssign":
                Response.Redirect("Finiquito?id=" + per_id + "&id2=" + as_id);
                break;
            default:
                break;
        }
    ...
    private void BindGridView(string varId, string varCed, string varPat, string varMat, string varNom, string varCas)
    {
        try
        {
            ...
            var resultados = _persona.ObtenerTablaGrilla__gamlp_finiquito(varId, "", varCed, "", varPat, varMat, varNom, varCas, "", "", "", "", "", "", pr_id);
