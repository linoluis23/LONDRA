...
public partial class Kardex_FiliacionFuncionario : System.Web.UI.Page
{
    ...
    protected void gv_items_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case "GetAssign":
                Response.Redirect("Filiacion.aspx?id=" + per_id + "&id2=" + as_id);
                break;
            case "FileVirtual":
                Response.Redirect("FileVirtualPdf.aspx?id=" + per_id + "&id2=" + as_id);
                break;
            default:
                break;
        }
