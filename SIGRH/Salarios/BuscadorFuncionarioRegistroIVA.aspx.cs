...
public partial class Salarios_BuscadorFuncionario_RegistroIVA : System.Web.UI.Page
{
    ...
    protected void gv_items_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            case "GetAssign":
                ...
                //Response.Redirect("RegistroAporteIVA?id=" + ci);
                Response.Redirect("RegistroAporteIVA?id=" + per_id + "&id2=" + as_id);
                break;
    ...
    private void BindGridView(string varId, string varCed, string varPat, string varMat, string varNom, string varCas)
    {
        try
        {
            ...
            gv_items.DataSource = _persona.ObtenerTablaGrilla__persona_plantaContrato(varId, "", varCed, "", varPat, varMat, varNom, varCas, "", "", "", "", "", "", Convert.ToInt32(gestion));
            gv_items.DataBind();
        }
