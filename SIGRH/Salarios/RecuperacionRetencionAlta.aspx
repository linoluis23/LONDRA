<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="RecuperacionRetencionAlta.aspx.cs" Inherits="MovimientoPersonal_RecuperacionRetencionAlta" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <!-- Header -->
    <div class="header pb-6" style="margin-top:-4em; margin-left:3em;width:80%"> 
        <div class="container-fluid">
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Descuentos: Montos fijos o cuotas</h6>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="ct-page-title">
                            ...
                            <p class="text-sm mb-0">Seleccione el tipo de pago a realizar (monto ÚNICO ó por CUOTAS)</p>
                        </div>
                    </div>
                    <asp:UpdatePanel ID="Up_form" runat="server">
                        <ContentTemplate>
                            <div class="card-body">
                                <div class="nav-wrapper" style="padding: 0 0 1rem 0;">
                                    <ul class="nav nav-pills nav-fill flex-column flex-md-row row">
                                        ...
                                        <li class="nav-item col-lg-6">
                                            <asp:LinkButton ID="BtnTabPC" Visible="true" CssClass="nav-link mb-sm-3 mb-md-0" Text="<i class='fas fa-coins mr-2'></i>Monto por Cuotas" ClientIDMode="Static" OnClick="BtnTabPC_Click" runat="server" />
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-body shadow">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- tr_monto -->
                                        <div class="form-group col-md-6">
                                            <label class="form-control-label" for="Txt_tr_monto">Monto</label>
                                    ...
                                    <asp:Panel ID="P_cuotas" Visible="false" runat="server">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <asp:TextBox ID="Txt_tc_cant_cuotass" CssClass="form-control numero" TextMode="Number" runat="server" />
                                                </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="form-control-label" for="Txt_tc_cant_cuotas">Total de Cuotas</label>
                                            <asp:DropDownList ID="Txt_tc_cant_cuotas" CssClass="form-control select2" data-minimum-results-for-search="Infinity" AppendDataBoundItems="true"  runat="server" />
                                            <asp:RequiredFieldValidator CssClass="text-danger display-5" ErrorMessage="(*) Campo Obligatorio" ControlToValidate="Txt_tc_cant_cuotas" ValidationGroup="add" InitialValue="0" Display="Dynamic" runat="server" />
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <asp:DropDownList ID="ddl_asignacion" AutoPostBack="true" OnSelectedIndexChanged="ddl_asignacion_SelectedIndexChanged" CssClass="form-control select2" data-minimum-results-for-search="Infinity" AppendDataBoundItems="true"  runat="server" />
                                        </div>
                                        </div>
                                <div class="row mt-3">
