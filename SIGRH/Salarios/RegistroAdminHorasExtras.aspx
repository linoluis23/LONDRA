<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="RegistroAdminHorasExtras.aspx.cs" Inherits="Salarios_RegistroAdminHorasExtras" %>
                                ...
                                <div class="modal-body p-0">
                                    <div class="card bg-secondary border-0 mb-0">
                                        <div class="card-header">
                                            <div class="text-muted text-center mt-2 mb-3"><small>REGISTRO HORAS EXTRAS</small></div>
                                        </div>
                                        ...
                                        <div class="form-group text-center">
                                            <asp:UpdatePanel ID="panelBtnRegistroHoras" runat="server">
                                                <ContentTemplate>
                                                    <asp:LinkButton ID="btn_guardar_horasExtras" Text="<i class='fas fa-save mr-2'></i>Guardar" ValidationGroup="AddHoras" CssClass="btn btn-success" OnClick="btn_guardar_horasExtras_Click" runat="server" />
                            ...
                            <div class="modal-content bg-gradient-dark6">
                                ...
                                <asp:UpdatePanel ID="panelEliminarHoras" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="form-group text-center">
                                            <asp:LinkButton ID="btn_eliminar_horasExtras" OnClick="btn_eliminar_horasExtras_Click" Text="<i class='fas fa-check-circle mr-2'></i>Aceptar" CssClass="btn btn-success" runat="server" />
