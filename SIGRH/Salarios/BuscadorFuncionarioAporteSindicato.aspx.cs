...
public partial class Salarios_BuscadorFuncionarioAporteSindicato : System.Web.UI.Page
{
    ...
    protected void gv_items_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            case "GetAssign":
                ...
                Response.Redirect("RegistroAporteSindicato?id=" + per_id + "&id2=" + as_id);
                break;
    ...
    private void BindGridView(string varId, string varCed, string varPat, string varMat, string varNom, string varCas)
    {
        ...
        try
        {
            ...
            DataSet ds = _persona.ObtenerTablaGrilla__persona_plantaTecLab(varId, "", varCed, "", varPat, varMat, varNom, varCas, "", "", "", "", "", "", pr_id);
