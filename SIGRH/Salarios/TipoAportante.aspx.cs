...
public partial class Salarios_TipoAportante : System.Web.UI.Page
{
    ...
    protected void GvLista_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        //if (data.Rows.Count > 0) { if (e.CommandName.Equals("GetNew")) Response.Redirect("TipoAportanteAlta?id=" + code); }
        //else sc = "$.notify({ icon: 'fas fa-exclamation', message: 'El funcionario no tiene una asignación vigente...!!' }, { type: 'warning' });";
        if (e.CommandName.Equals("GetNew")) { Response.Redirect("TipoAportanteAlta?id=" + code); }
        SetScript(sc);
    }
