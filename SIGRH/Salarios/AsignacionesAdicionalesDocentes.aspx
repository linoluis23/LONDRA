<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="AsignacionesAdicionalesDocentes.aspx.cs" Inherits="Salarios_AsignacionesAdicionalesDocentes" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:UpdatePanel runat="server" ID="UpdateDocentes">
        <ContentTemplate>
    <div class="header pb-6" style="margin-top:-4em; margin-left:-1em;width:85%"> 
        <div class="container-fluid">
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Cursos Temporada/Examenes Mesa</h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header border-bottom">
                <div class="ct-page-title">
                    <h3 class="mb-0">Búsqueda de Personal a Asignar</h3>
...
<%--                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group offset-md-3 col-md-3 align-self-end">
                                <asp:LinkButton ID="BtnBuscar" CssClass="btn btn-info btn-block" Text="<i class='fas fa-search'></i> Buscar" OnClick="btnVerificarCi_Click" runat="server" />
                            </div>
                        </div>
                    </asp:Panel>
        </div>
    ...
    <asp:UpdateProgress AssociatedUpdatePanelID="UpdateDocentes" runat="server">
        <ProgressTemplate>
            <div class="load"></div>
        </ProgressTemplate>
    </asp:UpdateProgress>
