<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="BuscadorFuncionarioHorasExtras.aspx.cs" Inherits="Salarios_BuscadorFuncionario_HorasExtras" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div id="block_ver_he" class="col-lg-6 col-5 text-right" style="display: block">
                                <asp:LinkButton ID="btn_ver_he" CssClass="btn btn-circle sticky-top-btn icon-prs icon-shape-prs bg-gradient-inst text-white rounded-circle shadow" Text="<i class='fas fa-user-clock'></i>" data-toggle="tooltip" data-placement='top' data-original-title="Ver Registros Horas Extras" OnClick="btn_ver_he_Click" ValidationGroup="ver_mov_reg" OnClientClick="if (Page_ClientValidate('ver_mov_reg')) { MostrarMascara(true); }" runat="server" />
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
    ...
    <div class="container-fluid mt--6">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <asp:TextBox ID="Txt_per_id_b" CssClass="form-control" type="number" runat="server" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Opciones" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" HeaderStyle-Width="130px">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton CommandName="GetAssign" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn bg-gradient-inst text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-plus'></i></span>" data-toggle='tooltip' data-placement='top' title='Asignar' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
        ...
        <%-- Modal Grilla Horas Extras --%>
        <div class="modal fade" id="modalHorasExtras" tabindex="-1" role="dialog" aria-labelledby="modal-notification" style="display: none;" aria-hidden="true" data-backdrop="static">
                        ...
                        <div class="card bg-secondary border-0 mb-0">
                            <div class="card-header">
                                <div class="text-muted text-center mt-2 mb-3">
                                    <h4 class="header-modal">HORAS EXTRAS</h4>
                                </div>
                            </div>
                            <div class="card-body px-lg-4 py-lg-4">
                                <div class="card">
                                    <div class="card-header">
                                        <div class=" ct-page-title">
                                            <h3 class="mb-0">Listado de Horas Extras</h3>
                                            <p class="text-sm mb-0">
                                                Detalle de los registros insertados en este mes.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="table-responsive py-4">
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="gv_horas_extras" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" OnPreRender="gv_horas_extras_PreRender" DataKeyNames="per_id" runat="server">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="nro_horas" HeaderText="Nro. Horas" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center grid-bold" />
                                                    </Columns>
                                                </asp:GridView>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                        <div class="col-md-12">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                    <div id="block_horasExtras" runat="server">
                                                        <span class="badge badge-pill badge-info">No existen registros de Horas Extras vigentes.</span>
                                                    </div>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
