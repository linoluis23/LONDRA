<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="RegistroSanciones.aspx.cs" Inherits="Salarios_RegistroSanciones" %>
    ...
    <div class="modal fade" id="modalSancionInasistencia" tabindex="-1" role="dialog" aria-labelledby="modal-notification" style="display: none;" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal- modal-dialog-centered modal-lg" role="document">
                ...
                <div class="card-wrapper">
                    <div class="card card-profile">                    
                        <div class=" ct-page-title">
                        <h3 class="mb-0 text-org2">Sanción por retraso o inasistencia</h3>
                    <div class="row">
                    <div class="col-6">
