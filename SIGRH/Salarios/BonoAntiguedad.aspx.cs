...
public partial class Salarios_BonoAntiguedad : System.Web.UI.Page
{
    ...
    protected void GvLista_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        //if (data.Rows.Count > 0) { if (e.CommandName.Equals("GetNew")) Response.Redirect("BonoAntiguedadAlta?id=" + code); }
