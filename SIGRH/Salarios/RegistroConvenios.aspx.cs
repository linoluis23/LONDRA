...
public partial class Salarios_RegistroConvenios : System.Web.UI.Page
{
    ...
    private void listaFiltradoTipoConvenio()
    {
        try
        {
            ...
            ddl_tipo_transaccion.DataSource = factor.ObtenerComboCovenios();
    ...
    private void listarGrillaConvenios()
    {
        ...
        try
        {
            factor = new cls_pla_factor();
            factor.tr_per_id = per_id;
            var aportes = factor.ListarGrillaConvenios();
