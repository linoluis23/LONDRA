<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="RegistroConvenios.aspx.cs" Inherits="Salarios_RegistroConvenios" %>
                            ...
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <div class="row">
                                            ...
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="exampleFormControlSelect1">Tipo Convenio</label>
                                        ...
                                        <asp:LinkButton ID="btnNuevoFactor" CssClass="btn btn-info btn-block btn-icon" Text="<span class='btn-inner--icon'><i class='fas fa-plus'></i></span><span class='btn-inner--text'>Nuevo Convenio</span>"  OnClick="btnNuevoFactor_Click"  runat="server" />
