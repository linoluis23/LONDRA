<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="BuscadorFuncionarioConvenios.aspx.cs" Inherits="Salarios_BuscadorFuncionarioConvenios" %>
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Descuentos por Convenios</h6>
                    </div>
            ...
            <div class="card-header">
                <div class=" ct-page-title">
                    ...
                    <p class="text-sm mb-0">
                        Para su búsqueda,  puede usar las siguientes opciones
                    </p>
                </div>
            </div>
            <div class="card-body">
