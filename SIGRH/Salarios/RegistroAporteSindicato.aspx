<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="RegistroAporteSindicato.aspx.cs" Inherits="Salarios_RegistroAporteSindicato" %>
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Aporte a Sindicato</h6>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-header">
                            <div class=" ct-page-title">
                                ...
                                <p class="text-sm mb-0">
                                    Detalle del tipo de aporte al sindicato del funcionario seleccionado.
                                </p>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                            ...
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="exampleFormControlSelect1">Tipo Transacción</label>
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="exampleFormControlSelect1">Estado Aporte</label>
                                                        <asp:DropDownList ID="ddl_tipo_aporte"  OnSelectedIndexChanged="ddl_tipo_aporte_SelectedIndexChanged" AutoPostBack="true"  AppendDataBoundItems="true" CssClass="form-control select2" data-minimum-results-for-search="Infinity" runat="server"></asp:DropDownList>
                                                    </div>
                                                    <asp:RequiredFieldValidator CssClass="text-danger display-5" ErrorMessage="(*) Campo Obligatorio" ControlToValidate="ddl_tipo_aporte" InitialValue="-1" Display="Dynamic" ValidationGroup="addGuardar" runat="server" />
                                                </ContentTemplate>
        <Triggers>
            <asp:AsyncPostBackTrigger  ControlID="ddl_tipo_transaccion" EventName="SelectedIndexChanged" />
        </Triggers>                                                
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                             <label class="form-control-label" for="exampleFormControlSelect1">Monto de descuento:</label>
                                             <asp:Literal ID="ltl_valor_descuento_sindicato" runat="server" />                                                                                        
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <asp:UpdatePanel ID="panelBtnGuardar" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:LinkButton ID="btn_guardar_aporte" CssClass="btn btn-success btn-block btn-icon" Text="<span class='btn-inner--icon'><i class='fas fa-save'></i></span><span class='btn-inner--text'>Guardar</span>" OnClick="btn_guardar_aporte_Click" ValidationGroup="addGuardar" runat="server" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class=" ct-page-title">
                                <h3 class="mb-0">Transacciones Registradas</h3>
                                <p class="text-sm mb-0">
                                    Detalle de los aportes del funcionario seleccionado.
                                </p>
                            </div>
                        </div>
                        <div class="table-responsive py-4">
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gv_aporte_sindicato" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" OnPreRender="gv_aporte_sindicato_PreRender" OnRowCommand="gv_aporte_sindicato_RowCommand" DataKeyNames="tr_id" runat="server">
                                        <Columns>
                                ...
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <div id="block_familia" runat="server">
                                            <span class="badge badge-pill badge-info">El funcionario no tiene registros de aportes a sindicato.</span>
                                        </div>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                    ...
                    <%-- Eliminar Aporte Sindicato --%>
                    <div class="modal fade" id="eliminarAporteSindicato" tabindex="-1" role="dialog" aria-labelledby="modal-notification" style="display: none;" aria-hidden="true">
                                ...
                                <asp:UpdatePanel ID="panelEliminarAporte" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="form-group text-center">
                                            <asp:LinkButton ID="btn_eliminar_aporte_sindicato" Text="<i class='fas fa-check mr-2'></i>Aceptar" CssClass="btn btn-success" OnClick="btn_eliminar_aporte_sindicato_Click" runat="server" />
