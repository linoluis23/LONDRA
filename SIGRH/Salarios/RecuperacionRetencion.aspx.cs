...
public partial class MovimientoPersonal_RecuperacionRetencion : System.Web.UI.Page
{
    ...
    protected void GvLista_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        //if (data.Rows.Count > 0) { if (e.CommandName.Equals("GetNew")) Response.Redirect("RecuperacionRetencionAlta?id=" + code); }
        //else sc = "$.notify({ icon: 'fas fa-exclamation', message: 'El funcionario no tiene una asignación vigente...!!' }, { type: 'warning' });";
        if (e.CommandName.Equals("GetNew")) { Response.Redirect("RecuperacionRetencionAlta?id=" + code); }
        SetScript(sc);
    }
