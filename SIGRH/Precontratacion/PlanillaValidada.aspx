<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="PlanillaValidada.aspx.cs" Inherits="Precontratacion_PlanillaValidada" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Lista de Pre-Contrato(s)</h6>
                    </div>
                    <div class="col-lg-6 col-5 text-right">
                        <asp:updatepanel id="up_btn_adic_nueva_frec" runat="server">
                            <ContentTemplate>
                                <asp:LinkButton ID="btn_adic_nueva_frec" Visible="false" CssClass="btn btn-circle sticky-top-btn icon-prs icon-shape-prs bg-gradient-inst text-white rounded-circle shadow" Text="<i class='fas fa-business-time'></i>" data-toggle="tooltip" data-original-title="Adicionar Frecuencia" OnClick="btn_adic_nueva_frec_Click" runat="server" />
                            </ContentTemplate>
                        </asp:updatepanel>
    ...
    <div class="container-fluid mt--6">
                        ...
                        <div class="text-right ml-auto">
                            <asp:updatepanel id="up_btn_enviar_planilla" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:LinkButton ID="btn_modificar_fecha" CssClass="btn btn-warning btn-round btn-icon" data-toggle="tooltip" data-original-title="Modificar fecha inicio" Text="<span class='btn-inner--icon'><i class='fas fa-edit'></i></span><span class='btn-inner--text'>Modificar fecha inicio</span>" OnClick="btn_modificar_fecha_Click" OnClientClick="MostrarMascara(true);" runat="server" />
                                </ContentTemplate>
                            </asp:updatepanel>
                        </div>
                    </div>
                                    ...
                                    <Columns>
                                        ...
                                        <HeaderTemplate>
                                            ...
                                            <label class="custom-toggle custom-toggle-dark">
                                                <asp:CheckBox ID="chk_marcar_todos" OnCheckedChanged="chk_marcar_todos_CheckedChanged" AutoPostBack="true" runat="server" />
                                        ...
                                        <asp:BoundField DataField="fr_id" HeaderText="Cod. Frec." HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center grid-font-size" />
                    ...
                    <div class="modal-body p-0">
                        <div class="card bg-secondary border-0 mb-0">
                            <div class="card-header">
                                <div class="text-muted text-center mt-2 mb-3"><small>ADICIÓN DE FRECUENCIA</small></div>
                            </div>
                            <div class="card-body py-lg-4">
                                ...
                                <div class="table-responsive py-2">
                                    <asp:updatepanel id="up_gv_frecuencias" runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="gv_frecuencias" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" OnPreRender="gv_frecuencias_PreRender" OnRowCommand="gv_frecuencias_RowCommand" DataKeyNames="fr_id" runat="server">
                                                <Columns>
                                                    <asp:TemplateField ItemStyle-CssClass="text-center">
                                                        <HeaderTemplate>
                                                            <span class="badge badge-lg badge-darkerw">Todos</span>
        ...
        <div class="modal fade" id="modalAdicionarFrecPost" tabindex="-1" role="dialog" aria-labelledby="modal-notification" style="display: none;" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal- modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-body p-0">
                        <div class="card bg-secondary border-0 mb-0">
                            <div class="card-header">
                                <div class="text-muted text-center mt-2 mb-3"><small>ADICIÓN DE FRECUENCIA A PLANILLA</small></div>
                            </div>
                            <asp:updatepanel runat="server">
                                <ContentTemplate>
                                    <div class="card-body px-lg-5 pb-lg-5">
                                        ...
                                        <h6 class="heading-small text-muted">Datos de la Frecuencia </h6>
                            ...
                            <div class="form-group text-right" style="padding-right: 3rem">
                                <asp:updatepanel id="up_btn_adicionar_frecuencia" runat="server">
                                    <ContentTemplate>

                                        <%--<asp:LinkButton ID="btn_adicionar_frecuencia" CssClass="btn btn-success" Text="<i class='fas fa-save mr-2'></i>Adicionar a Planilla" ValidationGroup="addFrecuencia"  OnClick="btn_adicionar_frecuencia_Click" OnClientClick="MostrarMascara(true); return DisableButton('addFrecuencia', 'ContentPlaceHolder1_btn_adicionar_frecuencia')" runat="server" />--%>
                                        <asp:LinkButton ID="btn_adicionar_frecuencia" CssClass="btn btn-success" Text="<i class='fas fa-save mr-2'></i>Adicionar a Planilla" ValidationGroup="addFrecuencia" OnClick="btn_adicionar_frecuencia_Click" OnClientClick="if (Page_ClientValidate('addFrecuencia')) { MostrarMascara(true); }" runat="server" />
                                        <%--<asp:LinkButton ID="btn_adicionar_frecuencia" CssClass="btn btn-success" Text="<i class='fas fa-save mr-2'></i>Adicionar a Planilla" ValidationGroup="addFrecuencia"  OnClick="btn_adicionar_frecuencia_Click" OnClientClick="MostrarMascara(true); if (Page_ClientValidate('addFrecuencia')) { MostrarMascara(false); } else { MostrarMascara(false); } " runat="server" />--%>
                                        <asp:LinkButton ID="btn_cancelar_frecuencia" class="btn btn-outline-github" Text="<i class='fas fa-times mr-2'></i>Cancelar" OnClick="btn_cancelar_frecuencia_Click" runat="server" />
        ...
        <div class="modal fade" id="modificarFecha" tabindex="-1" role="dialog" aria-labelledby="modal-notification" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
                <div class="modal-content bg-gradient-dark6">
                    <div class="modal-header">
                    </div>
                    ...
                    <asp:updatepanel id="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div class="modal-body">
                                <div class="py-3 text-center">
                                    <i class="fas fa-calendar ni-3x"></i>
                                    <h4 class="heading text-dark mt-4">¿Está seguro de modificar la fecha de inicio?</h4>
                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-control-label">Nueva Fecha asignación</label>
                                                    <asp:TextBox ID="txt_nueva_fecha_inicio" class="form-control datepickerDefault" runat="server" />
                                                    <asp:RequiredFieldValidator CssClass="text-danger display-5" ErrorMessage="(*) Campo Obligatorio" Display="Dynamic" ControlToValidate="txt_nueva_fecha_inicio" ValidationGroup="addFechaM" runat="server" />
                                                </div>
                                            </div>
                            <div class="col-lg-3">
                                                                                         </div>
                            ...
                            <div class="form-group text-center">
                                <asp:LinkButton ID="btn_confirmar_cambio" Text="<i class='fas fa-check mr-2'></i>Aceptar" CssClass="btn btn-success" OnClick="btn_confirmar_cambio_Click" OnClientClick="MostrarMascara(true);" ValidationGroup="addFechaM" runat="server" />
                                <button type="button" class="btn btn-outline-github" data-dismiss="modal"><i class="fas fa-times mr-2"></i>Cancelar</button>
                            </div>
                        </ContentTemplate>
                    </asp:updatepanel>
                ...
                <div class="modal-content" style="margin-top: 40px">
                    <div class="modal-body p-0">
                        <div class="card card-profile" style="margin-bottom: unset;">
                            <%--<img src="../Content/img/theme/Ngaruroro.jpeg" alt="Image placeholder" class="card-img-top" style="height: 180px;">--%>
                            <div class="row justify-content-center">
                                <div class="col-lg-3 order-lg-2">
                                    <div class="card-profile-image">
                                        <a href="#">
                                            <%--     <img src="../Content/img/theme/user3.jpg" class="rounded-circle">--%>
                                            <asp:updatepanel runat="server">
                                        <ContentTemplate>
                                ...
                                <asp:updatepanel id="up_datos_personales" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txt_ci" CssClass="form-control form-control-sm" OnTextChanged="txt_ci_TextChanged" AutoPostBack="true" runat="server" />
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txt_pre_paterno" CssClass="form-control form-control-sm letras" OnTextChanged="txt_pre_paterno_TextChanged" AutoPostBack="true" runat="server" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label class="form-control-label">Ap. Materno</label>
                                                    <asp:TextBox ID="txt_pre_materno" CssClass="form-control form-control-sm" OnTextChanged="txt_pre_paterno_TextChanged" AutoPostBack="true" runat="server" />
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txt_pre_nombres" CssClass="form-control form-control-sm" OnTextChanged="txt_pre_paterno_TextChanged" AutoPostBack="true" runat="server" />
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddl_pre_genero" CssClass="form-control form-control-sm select2" AppendDataBoundItems="true" data-minimum-results-for-search="Infinity" OnSelectedIndexChanged="ddl_pre_genero_SelectedIndexChanged" AutoPostBack="true" runat="server" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="ver_casada" class="col-lg-4" style="display: none">
                                                <div class="form-group text-center">
                                                    <label class="form-control-label pb-2">¿Ver Apellido Casada?</label>
                                                    <div>
                                                        <label class="custom-toggle custom-toggle-info">
                                                            <asp:CheckBox ID="chk_pre_ver_ap_casada" Checked="false" runat="server" />
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Si"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label class="form-control-label">Fecha asignación</label>
                                                    <asp:TextBox ID="txt_pre_fecha_asig" class="form-control form-control-sm datepickerDefault" OnTextChanged="txt_pre_fecha_asig_TextChanged" AutoPostBack="true" runat="server" />
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label class="form-control-label">Fecha baja</label>
                                                    <asp:TextBox ID="txt_pre_fecha_baja" class="form-control form-control-sm datepickerDefault" OnTextChanged="txt_pre_fecha_baja_TextChanged" AutoPostBack="true" runat="server" />
                                        ...
                                        <div id="d_tipo_item" class="row" runat="server">
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    ...
                                                    <%--<asp:TextBox ID="txt_pre_tipo_item" class="form-control form-control-sm" runat="server" />--%>
                                                    <asp:DropDownList ID="ddl_tipo_item" Enabled="false" CssClass="form-control form-control-sm select2" AppendDataBoundItems="true" data-minimum-results-for-search="Infinity" runat="server" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label class="form-control-label">Numero ítem</label>
                                                    <asp:TextBox ID="txt_pre_numero_item" Enabled="false" CssClass="form-control form-control-sm numero" runat="server" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
        ...
        <asp:updateprogress id="up4" associatedupdatepanelid="up_btn_adicionar_frecuencia" runat="server">
            <ProgressTemplate>
                <div class="load"></div>
            </ProgressTemplate>
        </asp:updateprogress>
