<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="PlanillaAprobacion.aspx.cs" Inherits="Precontratacion_PlanillaAprobacion" %>
    ...
    <div class="container-fluid mt--6">
                        ...
                        <div class="text-right ml-auto">
                            <asp:UpdatePanel ID="up_btn_enviar_planilla" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:LinkButton ID="btn_aprobar" CssClass="btn btn-slack btn-round btn-icon disabled" data-toggle="tooltip" data-original-title="Aprobar Planilla" Text="<span class='btn-inner--icon'><i class='fas fa-check'></i></span><span class='btn-inner--text'>Aprobar</span>" Visible="false" OnClick="btn_aprobar_Click" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </div>
                    </div>
        ...
        <asp:UpdateProgress ID="up3" AssociatedUpdatePanelID="up_confirmar_ajuste" runat="server">
            <ProgressTemplate>
                ...
                <asp:UpdateProgress ID="up4" AssociatedUpdatePanelID="up_cancelar_puesto" runat="server">
            <ProgressTemplate>
                <div class="load"></div>
            </ProgressTemplate>
        </asp:UpdateProgress>
