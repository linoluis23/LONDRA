<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="ListaFrecuenciaInicio.aspx.cs" Inherits="Precontratacion_FrecuenciaInicio" %>
                        ...
                        <ul class="list-group list-group-flush list my--3">
                            <asp:UpdatePanel ID="up_lv_categorias" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:ListView ID="lv_categorias" ClientIDMode="AutoID" OnItemCommand="lv_categorias_ItemCommand" DataKeyNames="cp_id, cod_poa, cat_estado" runat="server">
                                        <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="tDatail1" CommandName="GetAssign" CommandArgument="<%# Container.DataItemIndex %>" data-toggle='tooltip' data-placement='right' title='Ver Frecuencias' runat="server">
                                                            ...
                                                            <div class="row ">
                                                                ...
                                                                <div class="list-view-item-desc">
                                                                    <asp:Label ID="ltl_estado" CssClass='<%# (Eval("cat_estado").ToString() == "ENVIADO") ? "text-info font-weight-bold" : (Eval("cat_estado").ToString() == "VALIDADO") ? "text-success font-weight-bold" :  (Eval("cat_estado").ToString() == "OBSERVADO") ? "text-warning font-weight-bold" : "list-view-item-desc" %>' Text='<%# Eval("cat_estado") %>' runat="server" />
                                                                </div>
                                                            </div>
                                                        </asp:LinkButton>
                                                    </div>
