...
public partial class Precontratacion_ListaPlanillaAprobacion : System.Web.UI.Page
{
    ...
    private void listarPlanillas(int us_id = 0, int pr_id = 0)
    {
        ...
        var planilla_cr = planilla.ListarPlanillasAprobar();
    ...
    protected void lv_planilla_ItemCommand(object sender, ListViewCommandEventArgs e)
    {
        ...
        {
            case "GetAssign":
                Response.Redirect("PlanillaAprobacion?id=" + pl_id + "&id2=" + pl_ue + "&id3=" + Session["pr_id"].ToString());
                break;
            case "GetDetailPla":
