<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="Frecuencia.aspx.cs" Inherits="Precontratacion_Frecuencia" %>
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Reformulación de Frecuencias</h6>
                    </div>
                    <div class="col-lg-6 col-5 text-right">
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                <asp:LinkButton ID="btn_nueva_frecuencia" CssClass="btn btn-circle sticky-top-btn icon-prs icon-shape-prs bg-gradient-inst text-white rounded-circle shadow" Text="<i class='fas fa-plus'></i>" data-toggle="tooltip" data-original-title="Crear Frecuencia(s)" OnClick="btn_nueva_frecuencia_Click" OnClientClick="MostrarMascara(true);" runat="server" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive pb-4">
                        <asp:UpdatePanel ID="up_gv_frecuencias" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gv_frecuencias" CssClass="table table-bordered table-hover" AutoGenerateColumns="false" OnPreRender="gv_frecuencias_PreRender" OnRowCommand="gv_frecuencias_RowCommand" DataKeyNames="fr_id, ns_id" runat="server">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="fr_tiempo_uso" HeaderText="Tiempo Uso" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
                                        ...
                                        <asp:BoundField DataField="fr_observaciones" HeaderText="Observaciones" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center grid-font-size" />
                ...
                <div class="card-wrapper">
                    <div class="card">
                        ...
                        <div class="table-responsive py-4">
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gv_fracuencias_resumen" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" OnPreRender="gv_fracuencias_resumen_PreRender" OnRowCommand="gv_fracuencias_resumen_RowCommand" DataKeyNames="es_descripcion, fr_tiempo, fr_pu_descripcion" runat="server">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="cantidad" HeaderText="Cantidad" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center grid-bold" />
                                        </Columns>
                                    </asp:GridView>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                ...
                <div class="card-wrapper">
                    <div class="card">
                        ...
                        <div class="table-responsive py-4">
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gv_resumen_presup" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" OnPreRender="gv_resumen_presup_PreRender" OnRowCommand="gv_resumen_presup_RowCommand" DataKeyNames="pp_cp_id, pp_partida" runat="server">
                                        <Columns>
                                            <asp:BoundField DataField="pp_partida" HeaderText="Partida Presupuestaria" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" />
                                            <asp:BoundField DataField="monto" HeaderText="Monto (Bs)" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-right" DataFormatString="{0:N2}" />
                                            <asp:BoundField DataField="comprometido" HeaderText="Comprometido (Bs)" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-right" DataFormatString="{0:N2}" />
                                            <asp:BoundField DataField="saldo" HeaderText="Saldo (Bs)" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-right grid-bold" DataFormatString="{0:N2}" />
                                        </Columns>
                                    </asp:GridView>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                                    ...
                                    <ContentTemplate>
                                        <div class="card-body px-lg-5 py-lg-5">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-md-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="example4cols2Input">Fecha inicio </label>
                                                        <div class="input-group input-group-merge">
                                                            <div class="input-group-prepend  ">
                                                                <span class="input-group-text"><i class="ni ni-calendar-grid-58"></i></span>
                                                            </div>
                                                            <asp:TextBox ID="txt_fecha_inicio" AutoComplete="off" CssClass="form-control datepickerDefault" OnTextChanged="txt_fecha_inicio_TextChanged" AutoPostBack="true" runat="server" />
                                                        </div>
                                                ...
                                                <div class="col-sm-6 col-md-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="example4cols2Input">Fecha fin</label>
                                                        <div class="input-group input-group-merge">
                                                            <div class="input-group-prepend  ">
                                                                <span class="input-group-text"><i class="ni ni-calendar-grid-58"></i></span>
                                                            </div>
                                                            <asp:TextBox ID="txt_fecha_fin" AutoComplete="off" CssClass="form-control datepickerDefault" OnTextChanged="txt_fecha_fin_TextChanged" AutoPostBack="true" runat="server" />
                                                        </div>
                                                ...
                                                <div class="col-sm-6 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <asp:TextBox ID="txt_observaciones" class="form-control" runat="server" />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row pt-3">
                                                <div class="col-sm-6 col-md-6">
                                                    <asp:LinkButton ID="btn_adicionar_frecuencia" Text="<i class='fas fa-save mr-2'></i>Guardar" ValidationGroup="addFrecuencia" CssClass="btn btn-success btn-block" OnClick="btn_adicionar_frecuencia_Click" OnClientClick="if (Page_ClientValidate('addFrecuencia')) { MostrarMascara(true); }" runat="server" />
                                                </div>
                                                <div class="col-sm-6 col-md-6">
                                        ...
                                        <asp:HiddenField ID="hf_ns_id" runat="server" />
                ...
                <asp:UpdatePanel ID="up_eilminar_frec" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="form-group text-center">
                            <div class="input-group input-group-merge px-4 pb-4">
                                <div class="input-group-prepend  ">
                                    <span class="input-group-text"><i class="fas fa-edit"></i></span>
                                </div>
                                <asp:TextBox ID="txt_fr_observaciones" class="form-control" TextMode="multiline" Rows="5" runat="server" />
                            </div>
