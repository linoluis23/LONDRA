<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="ListaValidacionDoc.aspx.cs" Inherits="Precontratacion_ListaValidacionDoc" %>
                                        ...
                                        <div class="col-sm-6 col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <asp:TextBox ID="txt_cod" AutoComplete="off" class="form-control numero" runat="server" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <asp:TextBox ID="txt_ue" AutoComplete="off" class="form-control numero" runat="server" />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:ListView ID="lv_planilla" ClientIDMode="AutoID" OnItemCommand="lv_planilla_ItemCommand" DataKeyNames="pl_id, pl_ue, pl_estado" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <li class='<%# (Eval("pl_estado").ToString() == "VALIDADO POR RRHH") ? "list-group-item px-0 lv-item list-view-border list-view-item-bg-success" : (Eval("pl_estado").ToString() == "OBSERVADO") ? "list-group-item px-0 lv-item list-view-border list-view-item-bg-warning" : "list-group-item px-0 lv-item list-view-border" %> ' runat="server">
                                                    ...
                                                    <div class="col-10">
                                                        <asp:LinkButton ID="tDatail1" CommandName="GetAssign" CommandArgument="<%# Container.DataItemIndex %>" data-toggle='tooltip' data-placement='top' title='Ver Planilla' runat="server">
                                                            ...
                                                            <div class="row flex-nowrap">
                                                                ...
                                                                <div class="list-view-item-desc"><%# Eval("fecha_validacion") %></div>
                                                            </div>
                                                            <div class="row flex-nowrap">
                                                                <div class="list-view-item-title">Estado: </div>
                                                                <div class="list-view-item-desc">
                                                                    <asp:Label ID="ltl_estado" CssClass='<%# (Eval("pl_estado").ToString() == "OBSERVADO") ? "text-gold font-weight-bold" : (Eval("pl_estado").ToString() == "APROBADO") ? "text-success font-weight-bold" :  (Eval("pl_estado").ToString() == "VALIDADO POR RRHH") ? "text-vimeo font-weight-bold" : (Eval("pl_estado").ToString() == "AJUSTAR") ? "text-warning font-weight-bold" : (Eval("pl_estado").ToString() == "ANULADO") ? "text-light4 font-weight-bold" :"list-view-item-desc" %>' Text='<%# Eval("pl_estado") %>' runat="server" />
                                                                </div>
                                                            </div>
                                                        </asp:LinkButton>
                                                    </div>
