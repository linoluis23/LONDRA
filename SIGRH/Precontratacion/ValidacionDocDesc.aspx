<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="ValidacionDocDesc.aspx.cs" Inherits="Precontratacion_ValidacionDocDesc" %>
                                            ...
                                            <ItemTemplate>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" style="">
                                                        <asp:LinkButton CommandName="GetAssign" CommandArgument="<%# Container.DataItemIndex %>" CssClass="dropdown-item" Text="<i class='fas fa-tasks'></i><span>Documentos faltantes</span>" Visible='<%# Eval("pre_estado_x").ToString().Trim() != "O" ? true : false %>' runat="server" />
                                                        ...
                                                        <hr class="my-2">
                                                        <asp:LinkButton CommandName="GetValidar" CommandArgument="<%# Container.DataItemIndex %>" CssClass="dropdown-item" Text="<i class='fas fa-check'></i><span>Validar Pre-Contrato</span>" runat="server" />
                                                        ...
                                                        <asp:LinkButton CommandName="GetObservar" CommandArgument="<%# Container.DataItemIndex %>" CssClass="dropdown-item" Text="<i class='fas fa-eye'></i><span>Observar Pre-Contrato</span>" Visible='<%# (Eval("pre_estado_x").ToString().Trim() == "V" || Eval("pre_estado_x").ToString().Trim() == "VR") ? true : false %>' runat="server" />
                                                    </div>
                                                </div>
                            ...
                            <asp:UpdatePanel ID="up_guardar_requisitos" runat="server">
                                <ContentTemplate>
                                    <div class="card-body ">
                                        ...
                                        <p class="text-sm mb-0 mb-3 pb-2 text-justify" style="font-size: 0.875rem;">En el siguiente listado se muestra los documentos faltantes por el interesado.</p>


                                        <div class="row">
                                            <div class="col-sm-6 col-md-12">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="exampleFormControlSelect1">Documentos faltantes</label>
                                                    <asp:ListBox ID="lb_documentos" class="form-control select2" SelectionMode="Multiple" runat="server"></asp:ListBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row pt-3">
