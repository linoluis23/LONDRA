<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="ListaPlanillaValidacion.aspx.cs" Inherits="Precontratacion_ListaPlanillaValidacion" %>
                                                        ...
                                                        <div class="row flex-nowrap">
                                                            <div class="list-view-item-title">Estado: </div>
                                                              <div class="list-view-item-desc">
                                                                    <asp:Label ID="ltl_estado" CssClass='<%# (Eval("pl_estado").ToString() == "ENVIADO") ? "text-info font-weight-bold" : (Eval("pl_estado").ToString() == "APROBADO") ? "text-success font-weight-bold" :  (Eval("pl_estado").ToString() == "VALIDADO") ? "text-vimeo font-weight-bold" : (Eval("pl_estado").ToString() == "AJUSTAR") ? "text-warning font-weight-bold" :"list-view-item-desc" %>' Text='<%# Eval("pl_estado") %>' runat="server" />
                                                              </div>
                                                        </div>
                                                        </asp:LinkButton>
                                                    </div>
