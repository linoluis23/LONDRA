<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="UsuariosBusqueda.aspx.cs" Inherits="Seguridad_UsuariosBusqueda" %>
        ...
        <div id="dResult" class="card" style="display: none;">
            ...
            <div class="card-body">
                ...
                <asp:UpdatePanel ID="Up_list" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GvLista" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" DataKeyNames="as_per_id" OnPreRender="GvLista_PreRender" OnRowCommand="GvLista_RowCommand" runat="server">
                            <Columns>
                                <asp:BoundField DataField="as_per_id" HeaderText="Código" />
