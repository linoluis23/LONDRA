<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="ProcesoSueldos.aspx.cs" Inherits="AdministracionDePersonal_ProcesoSueldos" %>
                    ...
                    <div class="header-body">
                        <div class="row align-items-center py-4">
                            <div class="col-lg-6 col-7">
                                <h6 class="h2 text-light d-inline-block mb-0">Proceso de Sueldos</h6>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div runat="server" id="divProcesoSanciones" visible="false" class="timeline-block">
                                            <span class="timeline-step badge-info">5</span>
                                            <div class="timeline-content d-flex align-items-center">
                                                <p class="text-sm mb-0">Sanciones</p>
                                                <div class="text-right ml-auto">
                                                    <asp:Button ID="btnProcesoSanciones" OnClick="btnProcesoSanciones_Click" Text="Ejecutar"  runat="server" CssClass="btn btn-secondary  btn-round btn-icon" />
                                                </div>
                                            </div>
                                        </div>
