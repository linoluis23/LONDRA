...
public partial class DescriptorPuesto_ReporteDescriptorPuesto : System.Web.UI.Page
{
    ...
    private void cargarReporteViatico(string pu_id)
    {
        ...
        "/ReportesUAP/descriptor_de_puestos";
        List<ReportParameter> paramList = new List<ReportParameter>();
        paramList.Add(new ReportParameter("desc_id", pu_id, false));
