<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="Administrar_evaluacion_rendimiento.aspx.cs" Inherits="Evaluacion_Administrar_evaluacion_rendimiento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container-fluid">
        <asp:UpdatePanel ID="PanelEvaluacionRendimiento" runat="server">
            <ContentTemplate>
