<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="HistorialEvaluacionDesempenio.aspx.cs" Inherits="Evaluacion_HistorialEvaluacionDesempenio"  %>
...
<style>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6  pl-0 pr-0 pt-0" data-select2-id="9">
                <div class="card mb-4 ">
                    <!-- Card header -->
                        ...
                        <div class="card-header d-flex align-items-center">
                            <div class="d-flex align-items-center ct-page-title">
                                <div class="text-dark font-weight-600 text-sm">
                                    REPORTES   <asp:Label ID="lblEvaluacionReporte" runat="server" Text=""></asp:Label>          
                                </div>
                            </div>
                        </div>
