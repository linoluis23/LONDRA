<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="RegistroFoto.aspx.cs" Inherits="Configuraciones_RegistroFoto" %>
                    ...
                    <div class="card-body">
                        <div class="pb-2">
                            <%--                    <label for="file-input" class="file-upload btn btn-vimeo btn-block">
                                <i class="fa fa-upload mr-2"></i>Subir Foto
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-header text-center border-0">
                                <h3 class="mb-0">Foto Actual</h3>

                            </div>
                            <div class="card-body">
                                <asp:Image ID="imgFun" class="img-thumbnail img-fluid rounded mx-auto d-block" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
