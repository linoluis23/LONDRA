<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="RegistroAdminFactores.aspx.cs" Inherits="Configuraciones_RegistroAdminFactores" %>
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Administración de Factores</h6>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class=" ct-page-title">
                                <h3 class="mb-0">Listado de Factores</h3>
                                <p class="text-sm mb-0">
                                    Detalle de los factores registrados.
                                </p>
                            </div>
                        </div>
                        <div class="table-responsive py-4">
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gv_factor" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" OnPreRender="gv_factor_PreRender" OnRowCommand="gv_factor_RowCommand" DataKeyNames="fa_id" runat="server">
                                        <Columns>
