...
public partial class ControlPersonal_BuscadorAdmControlPersonal : System.Web.UI.Page
{
    ...
    protected void gv_items_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            case "GetAssign":
                ...
                Response.Redirect("AdminControlPersonal?id=" + per_id + "&id2=" + as_id);
                break;
    ...
    private void BindGridView(string varId, string varCed, string varPat, string varMat, string varNom, string varCas)
    {
        ...
        try
        {
            ...
            gv_items.DataSource = _persona.ObtenerTablaGrilla__persona_plantaContrato(varId, "", varCed, "", varPat, varMat, varNom, varCas, "", "", "", "", "", "", pr_id);
            gv_items.DataBind();
        }
