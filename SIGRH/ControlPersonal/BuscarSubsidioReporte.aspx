<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="BuscarSubsidioReporte.aspx.cs" Inherits="ControlPersonal_ReporteSubsidio" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:LinkButton ID="BtnBuscar" OnClick="BtnBuscar_Click" CssClass="btn btn-info btn-block" Text="<i class='fas fa-search'></i> Buscar" runat="server" />
                                    </div>
                                </div>
                            </div>
                        </asp:Panel>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive py-4">
                        <asp:UpdatePanel ID="up_gv_items" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gv_items" OnRowCommand="gv_items_RowCommand" CssClass="table table-bordered table-hover table-striped" OnPreRender="gv_items_PreRender" AutoGenerateColumns="false" DataKeyNames="per_id, ab_id" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Opciones" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" HeaderStyle-Width="130px">
                                            <ItemTemplate>
                                                <asp:LinkButton CommandName="print" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn bg-gradient-inst text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-print fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='Reporte Lactancia' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
