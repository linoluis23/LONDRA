...
public partial class ControlPersonal_ReporteAsistencia : System.Web.UI.Page
{
    ...
    protected void GvLista_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        Session["per_id_reporte"] = code;
        if (e.CommandName.Equals("verReporte")) { Response.Redirect("ReporteAsistenciaIndividual.aspx"); }
        //SetScript(sc);
    }
