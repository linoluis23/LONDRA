<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSIGRH.master" AutoEventWireup="true" CodeFile="ReporteAsistencia.aspx.cs" Inherits="ControlPersonal_ReporteAsistencia" %>
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-light d-inline-block mb-0">Control de Asistencia</h6>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GvLista" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" DataKeyNames="per_id" OnPreRender="GvLista_PreRender" OnRowCommand="GvLista_RowCommand" runat="server">
                            <Columns>
                                ...
                                <asp:BoundField DataField="as_estado" HeaderText="Estado" />
...
<%--                                        <div class="col-auto">
                                            ...
                                            <div class="dropdown-menu dropdown-menu2 dropdown-menu-right">
                                                <asp:LinkButton CommandName="verReporte" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn bg-gradient-inst text-white btn-sm dropdown-item" Text="<span class='btn-inner--icom'><i class='far fa-file-alt'></i></span>" data-toggle="tooltip" data-placement="top" title="Ver" runat="server" />
                                            </div>
                                        </div>--%>
                                                <asp:LinkButton CommandName="verReporte" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn bg-gradient-inst text-white btn-sm" Text="<span class='btn-inner--icon'><i class='fas fa-file fa-lg'></i></span>" data-toggle='tooltip' data-placement='top' title='Ver' runat="server" />
